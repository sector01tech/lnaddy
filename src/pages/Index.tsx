                ...
                {address.nwcConnection ? (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground font-mono">
                      {address.nwcConnection.substring(0, 15)}...
                    </span>
                  </div>
                ) : (
            ...
            <div className="mt-4 pt-4 border-t border-border/50">
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1">
                  <Input
                    type={showNWCString ? "text" : "password"}
                    placeholder="nostr+walletconnect://..."
                    value={nwcString}
                    onChange={(e) => setNWCString(e.target.value)}
                    className="flex-1 bg-background/50 border-border/50 font-mono pr-10"
                  />
                  <button
                    type="button"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex gap-2">
              ...
              {/* Mobile login button */}
              <LoginArea className="flex sm:hidden">
